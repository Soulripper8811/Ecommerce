  ...
  return (
    <>
      <div
        ...
        } xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-[#000] w-[7%] hover:w-[15%] h-[100vh]  fixed `}
      ...
      >
        ...
        <div className=" relative">
          ...
          {dropdownOpen && userInfo && (
            <ul
              className={` absolute right-0 mt-2 mr-14 space-y-2 bg-black border border-white text-gray-600 ${
